...
{ Testes de Redis.PubSub (DUnitX). Mesma cobertura do tests\Unit\fpc\Redis.PubSubTests.pas
...
type
  ...
  [TestFixture]
  TRedisPubSubParseTests = class
  public
    [Test] procedure Message_EmResp2_EReconhecida;
    [Test] procedure Message_EmResp3_ComoPush;
    [Test] procedure PMessage_TemQuatroItens;
    [Test] procedure SMessage_EReconhecida;
    [Test] procedure Confirmacoes_DasSeisFormas;
    [Test] procedure AridadeErrada_NaoEPubSub;
    [Test] procedure ContagemQueNaoEInteiro_NaoEConfirmacao;
    [Test] procedure RespostaComum_NaoEPubSub;
    [Test] procedure Nulo_NaoEPubSub;
    [Test] procedure ParseMessage_PreencheCanalEPayload;
    [Test] procedure ParseMessage_PadraoTrazOCanalReal;
    [Test] procedure ParseMessage_PayloadBinarioIntacto;
    [Test] procedure ParseMessage_NaoEMensagem_DevolveFalse;
    [Test] procedure Permitido_EmModoDeAssinatura;
  end;

  [TestFixture]
  TRedisSubscriberTests = class
  public
    [Test] procedure Subscribe_EscreveOComandoNoFio;
    [Test] procedure Subscribe_EsperaAConfirmacaoDoServidor;
    [Test] procedure Subscribe_DeDentroDoCallback_NaoEspera;
    [Test] procedure Unsubscribe_TiraDaListaConfirmada;
    [Test] procedure Unsubscribe_SemArgumentos_LimpaTudo;
    [Test] procedure PSubscribe_RegistraPadrao;
    [Test] procedure SSubscribe_RegistraShard;
    [Test] procedure Mensagem_ChegaNoCallback;
    [Test] procedure Mensagens_ChegamNaOrdem;
    [Test] procedure MensagemDePadrao_TrazPadraoECanal;
    [Test] procedure MensagemBinaria_ChegaIntacta;
    [Test] procedure CallbackQueLevanta_NaoDerrubaOAssinante;
    [Test] procedure Execute_DeDentroDoCallback_Levanta;
    [Test] procedure Resp2_ComandoComumComAssinatura_Levanta;
    [Test] procedure Resp2_ComandoComumSemAssinatura_Passa;
    [Test] procedure Ping_RespondePong;
    [Test] procedure NomeVazio_Levanta;
    [Test] procedure SemStart_Levanta;
    [Test] procedure Queda_ZeraAsAssinaturasEAvisa;
    [Test] procedure Adotado_NaoReconecta;
    [Test] procedure Stop_EIdempotente;
  end;
...
initialization
  TDUnitX.RegisterTestFixture(TRedisPubSubParseTests);
  TDUnitX.RegisterTestFixture(TRedisSubscriberTests);

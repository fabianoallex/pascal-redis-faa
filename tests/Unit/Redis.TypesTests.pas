...
{ Testes de Redis.Types (DUnitX). Mesma cobertura do tests\Unit\fpc\Redis.TypesTests.pas
...
type
  [TestFixture]
  TRedisUtf8Tests = class
  public
    [Test] procedure Encode_Ascii;
    [Test] procedure Encode_Acentos_ProduzBytesUtf8;
    [Test] procedure Encode_Vazio;
    [Test] procedure Decode_Vazio;
    [Test] procedure RoundTrip_ComAcentos;
    [Test] procedure RoundTrip_TextoLongo;
    [Test] procedure Decode_PreservaBytesArbitrarios;
    [Test] procedure Decode_BytesInvalidos_NaoLevanta;
  end;

  [TestFixture]
  TRedisNumberTests = class
  public
    [Test] procedure FormatDouble_UsaPontoDecimal;
    [Test] procedure FormatDouble_Inteiro_SemCasas;
    [Test] procedure FormatDouble_Infinito;
    [Test] procedure FormatDouble_InfinitoNegativo;
    [Test] procedure FormatDouble_Nan;
    [Test] procedure FormatDouble_RoundTrip;
    [Test] procedure ParseDouble_Simples;
    [Test] procedure ParseDouble_Infinitos;
    [Test] procedure ParseDouble_Nan;
    [Test] procedure ParseDouble_ComEspacos;
    [Test] procedure ParseDouble_TextoInvalido_Falha;
    [Test] procedure ParseInt64_Positivo;
    [Test] procedure ParseInt64_Negativo;
    [Test] procedure ParseInt64_Limites;
    [Test] procedure ParseInt64_Vazio_Falha;
    [Test] procedure ParseInt64_SoSinal_Falha;
    [Test] procedure ParseInt64_ComEspaco_Falha;
    [Test] procedure ParseInt64_NaoNumerico_Falha;
  end;

  [TestFixture]
  TRedisArgTests = class
  public
    [Test] procedure Arg_String;
    [Test] procedure Arg_StringComAcentos_VaiEmUtf8;
    [Test] procedure Arg_Inteiro;
    [Test] procedure Arg_Int64Grande;
    [Test] procedure Arg_Double_UsaPontoDecimal;
    [Test] procedure Arg_Boolean_ViraUmOuZero;
    [Test] procedure Arg_Bytes_PreservaBinario;
    [Test] procedure Arg_TiposMisturados_NoMesmoArray;
  end;

  [TestFixture]
  TRedisParamsTests = class
  public
    [Test] procedure Default_ApontaParaLocalhost;
    [Test] procedure Default_FalaResp2SemTls;
    [Test] procedure Default_TemTimeouts;
  end;

  [TestFixture]
  TRedisReplyKindNameTests = class
  public
    [Test] procedure TodosOsKinds_TemNome;
  end;
...
initialization
  TDUnitX.RegisterTestFixture(TRedisUtf8Tests);
  TDUnitX.RegisterTestFixture(TRedisNumberTests);
  TDUnitX.RegisterTestFixture(TRedisArgTests);
  TDUnitX.RegisterTestFixture(TRedisParamsTests);
  TDUnitX.RegisterTestFixture(TRedisReplyKindNameTests);

...
type
  ...
  [TestFixture]
  TRedisStreamHelpersTests = class
  public
    [Test] procedure StreamId_MontaMsEHifenESequencia;
    [Test] procedure TryParseStreamId_QuebraNasDuasPartes;
    [Test] procedure TryParseStreamId_SemHifen_DevolveFalse;
    [Test] procedure TryParseStreamId_AceitaOParenteseDeExtremoAberto;
    [Test] procedure StreamIdExclusive_AcrescentaOParentese;
    [Test] procedure StreamIdExclusive_NaoDuplicaOParentese;
    [Test] procedure ReplyToStreamEntries_NuloViraListaVazia;
    [Test] procedure ReplyToStreamEntries_ForaDoFormato_Levanta;
    [Test] procedure ReplyToStreamData_Resp2_ListaDePares;
    [Test] procedure ReplyToStreamData_Resp3_MapaAchatado;
    [Test] procedure FindStreamData_AchaPeloNomeENaoPelaPosicao;
  end;

  [TestFixture]
  TRedisStreamsCommandsTests = class
  public
    [Test] procedure XAdd_UsaAsteriscoEDevolveOId;
    [Test] procedure XAdd_SemCampo_Levanta;
    [Test] procedure XAdd_QuantidadeImpar_Levanta;
    [Test] procedure XAddId_MandaOIdEscolhido;
    [Test] procedure XAddMaxLen_Aproximado_MandaOTilAntesDoNumero;
    [Test] procedure XAddMaxLen_Exato_MandaOIgual;
    [Test] procedure XAddMinId_MandaMinIdAntesDoAsterisco;
    [Test] procedure XTrimMaxLen_AproximadoPorPadrao;
    [Test] procedure XTrimMinId_Exato;
    [Test] procedure XLen_DevolveOTamanho;
    [Test] procedure XDel_ContaOsQueExistiam;
    [Test] procedure XDel_SemId_NaoVaiAoServidor;
    [Test] procedure XRange_SemCount_NaoMandaCount;
    [Test] procedure XRange_ComCount_MandaOModificador;
    [Test] procedure XRange_LeIdECamposPorNome;
    [Test] procedure XRange_CampoAusente_TryFieldValueDevolveFalse;
    [Test] procedure XRange_EntradaApagada_VemSemCampos;
    [Test] procedure XRevRange_InverteOsExtremos;
    [Test] procedure XRead_MontaOBlocoStreams;
    [Test] procedure XRead_ComCount_CountAntesDeStreams;
    [Test] procedure XRead_ChavesEIdsDesbalanceados_Levanta;
    [Test] procedure XRead_SemChave_Levanta;
    [Test] procedure XRead_NadaNovo_NuloViraListaVazia;
    [Test] procedure XRead_Resp2_UmaEntradaPorChave;
    [Test] procedure XRead_Resp3_MapaAchatado_MesmoResultado;
    [Test] procedure XReadBlocking_MandaBlockEmMilissegundos;
    [Test] procedure XReadBlocking_RestauraOTimeoutDaConexao;
    [Test] procedure XGroupCreate_ComMkStream;
    [Test] procedure XGroupTryCreate_BusyGroup_DevolveFalseSemLevantar;
    [Test] procedure XGroupTryCreate_OutroErro_Levanta;
    [Test] procedure XGroupDestroy_ZeroEhFalse;
    [Test] procedure XGroupDelConsumer_DevolveAsPendenciasPerdidas;
    [Test] procedure XReadGroup_MontaGroupCountENoack;
    [Test] procedure XReadGroup_ModoNovo_MandaOMaiorQue;
    [Test] procedure XReadGroupBlocking_BlockEntreCountENoack;
    [Test] procedure XAck_ContaOsConfirmados;
    [Test] procedure XAck_SemId_NaoVaiAoServidor;
    [Test] procedure XPendingSummary_LeTotalFaixaEConsumidores;
    [Test] procedure XPendingSummary_SemPendencia_VemZeradoESemIds;
    [Test] procedure XPendingRange_MandaFaixaEContagem;
    [Test] procedure XPendingRange_ComConsumidor_VaiNoFim;
    [Test] procedure XPendingRange_LeOciosidadeEEntregas;
    [Test] procedure XPendingIdle_MandaIdleAntesDaFaixa;
    [Test] procedure XClaim_MandaMinIdleEOsIds;
    [Test] procedure XClaim_SemId_Levanta;
    [Test] procedure XClaimJustId_MandaJustIdNoFim;
    [Test] procedure XAutoClaim_LeCursorEntradasEApagados;
    [Test] procedure XAutoClaim_RespostaDeDoisItens_AindaFunciona;
    [Test] procedure XInfoStream_MapaAchatado_AcessoPorChave;
  end;
...
initialization
  ...
  TDUnitX.RegisterTestFixture(TRedisStreamHelpersTests);
  TDUnitX.RegisterTestFixture(TRedisStreamsCommandsTests);

...
{ Testes de Redis.Pool (FPCUnit). Mesma cobertura do tests\Unit\Redis.PoolTests.pas
...
uses
  ...
  Redis.Types, Redis.Connection, Redis.Pool, Redis.ConnectionTests;
...
type
  ...
  TRedisPoolParamsTests = class(TTestCase)
  published
    procedure Default_TemTetoEPrazos;
    procedure MaxSizeInvalido_ViraUm;
  end;

  TRedisPoolTests = class(TTestCase)
  published
    procedure Acquire_AbreConexaoNova;
    procedure Release_DevolveParaOcioso;
    procedure Acquire_ReusaAConexaoOciosa;
    procedure Acquire_NoTeto_LevantaDepoisDoPrazo;
    procedure Acquire_SemEspera_LevantaNaHora;
    procedure Acquire_EsperaADevolucaoDeOutraThread;
    procedure Release_ConexaoInvalidada_Descarta;
    procedure Release_ConexaoSuja_Descarta;
    procedure Release_BancoTrocado_Descarta;
    procedure Release_Nil_NaoExplode;
    procedure HealthCheck_OciosaQueCaiu_ETrocada;
    procedure HealthCheck_Desligado_NaoConfere;
    procedure Ociosa_VencidaPorTempo_EPodada;
    procedure Falha_AoAbrir_DevolveAVaga;
    procedure Close_FechaAsOciosasERecusaAcquire;
    procedure Close_NaoDerrubaConexaoEmprestada;
  end;
...
initialization
  RegisterTest(TRedisPoolParamsTests);
  RegisterTest(TRedisPoolTests);
